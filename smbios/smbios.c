...
void init_smbios(struct smbios_data* data, void * smbios32_address, void * smbios64_address) {
    struct smbios2_entry_point * smbios32 = (struct smbios2_entry_point*)smbios32_address;
    struct smbios3_entry_point * smbios64 = (struct smbios3_entry_point*)smbios64_address;
